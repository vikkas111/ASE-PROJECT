...
public class PoliceLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mlogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String character = "@police.com";
                String text = muser_name.getText ().toString ();


                if (muser_name.getText().length() > 0 && mpassword.getText().length() > 0 && text.contains ("@police.com")) {
                    Intent launchactivity= new Intent(PoliceLoginActivity.this,PoliceHomeActivity.class);
                    startActivity(launchactivity);
                    //new LoginApi(PoliceLoginActivity.this).execute("");

                }
                else if(muser_name.getText().length() > 0 && mpassword.getText().length() > 0 && text.contains ("@gmail.com")) {
                    Intent launchactivity1= new Intent(PoliceLoginActivity.this,PublicHomeActivity.class);
    ...
    public String checkLogin() {
        ...
        String imageUploadURL = "https://criminaldatabase-s3.herokuapp.com/v1/sessions";
