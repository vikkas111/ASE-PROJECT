package com.example.criminaldatabase.maps;
...
public class MapsActivity extends FragmentActivity implements
    ...
    private static final String API_KEY = "AIzaSyAI03bVOk5kQRl_eT4ugt1TcS0BissVt_s";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LatLng loc = getLocationFromAddress(MapsActivity.this, str);
        ...
        mselectLocation = (Button) findViewById(R.id.selectLocation);
    ...
    public static ArrayList autocomplete(String input) {
        ...
        try {
            ...
            Log.e("TAG", "Cannot process JSON res", e);
        }
